...
import { MessageSquare, ArrowLeft, Clock, CheckCircle2, AlertTriangle } from "lucide-react";
  ...
  return (
    <AppLayout activePage="Detalle Candidato" userRole="tutor" userName="Ana García">
      <div className="mb-6 flex justify-between items-center">
        ...
        {/* Este botón iría fijo en la columna derecha en desktop, pero lo ponemos aquí para mejor responsiveness general, o en su contenedor */}
      </div>
